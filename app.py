...
data = load_dati_comunali("stefanocasagrande-hash/dmodolomiti-turismo-veneto/dati-mensili-per-comune")
provincia = load_provincia_belluno("stefanocasagrande-hash/dmodolomiti-turismo-veneto/dati-provincia-annuali")
stl_dolomiti, stl_belluno = load_stl_data("stefanocasagrande-hash/dmodolomiti-turismo-veneto/stl-presenze-arrivi")
